...
results_file = "./output/fit_results_1274.dat"
...
def tilted_double_gaussian(xy, par):
    ...
    x, y = xy
    theta = 0
    A, mu_x, sigma_x, mu_y, sigma_y = par
...
def write_fit_results_with_integration(
    ...
    with open(file_path, "w") as f:
        # Header
        f.write("# angle A A_err mu_x mu_x_err sigma_x sigma_x_err mu_y mu_y_err sigma_y sigma_y_err integrated integrated_err run_time\n")
...
output_path = "C:/Users/theom/OneDrive/Bureau/NPAX/TL/output/fit_results_with_integration_1274.dat"
